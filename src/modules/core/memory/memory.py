...
class MemoryManager:
    _current_session: MemorySession
    ...
    def _write_session(self, path: str) -> None:
        with open(path, "w", encoding="utf-8") as file:
            _ = file.write(self._current_session.model_dump_json(indent=4))
    ...
    def add_message(self, message: ChatCompletionMessageParam) -> None:
        ...
        self._current_session.memories.append(memory)
    ...
    def messages(self) -> list[ChatCompletionMessageParam]:
        ...
        for memory in self._current_session.memories:
